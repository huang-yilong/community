...
//        loginTicketMapper.updateStatus(ticket, 1);
    ...
    public Map<String, Object> sendCode(String email, String emailCode) {
        //验证邮箱
        Map<String, Object> map = new HashMap<>();
    ...
    public Map<String, Object> reset(String email, String emailCode, String code, String password) {
        Map<String, Object> map = new HashMap<>();
        User user = userMapper.selectByEmail(email);
        if (user == null) {
            map.put("emailMsg", "邮箱未注册");
...
//        return userMapper.updateHeader(userId, headerUrl);
    ...
    public Map<String, Object> changePassword(User user, String password, String newPassword, String confirm) {
        Map<String, Object> map = new HashMap<>();
